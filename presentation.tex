...
{Introduction}
{
	...
	\tab{|l | l|}{
		...
		Provision of acrylamide beads to IP & In progress \\ \hline} \vs{0.4cm}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ft
{Recap: the ion exchange experiment}
{
	\ul{%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ft
{$R\bar{NMR_4} + Na^+ \leftrightarrow R\bar{Na} + NMe_4^+$ exchange}
{
	\mcol{2}{
		\fig{scale=0.3}{figs/graph1.PNG}
		\Repeat{4}{\vphantom{q}}
		\vphantom{q}
		\vphantom{q}
		\vphantom{q}
		\fig{scale=0.3}{figs/graph2-1}
		\fig{scale=0.3}{figs/graph2-2}
		\fig{scale=0.3}{figs/graph2-3}	
	}
}
...
\f
{
	\fig{scale=0.3}{figs/graph3-1}
	\fig{scale=0.3}{figs/graph3-2}
	\fig{scale=0.3}{figs/graph3-3}
	
	\ul
	{
		\li{60 mesh fraction AG50WX8 beads}
	}
%	var('D','n','t','r','F')
%	D = 0.000000000001
%	
%	x = list(range(0,1200,10))
%	y = []
%	
%	def f(D,t,r):
%	return 1 - 6/pi^2 * sum(1/n^2 * e^(-(D*(pi^2)*(n^2)*t*(r^-2))), n, 1, 10)     
%	
%	
%	@interact
%	def plotDiffuse(D=slider(0.000000000001, 0.0000000001, 0.000000000001, 'Diffusion Coefficient'),
%	r=slider(0.000125,0.00125, 0.000125, 'Radius')):
%	y = []
%	for item in x:
%	t = item
%	func = f(D,t,r)
%	y.append(numerical_approx(func))
%	
%	show(scatter_plot(zip(x, y)))
